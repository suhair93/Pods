...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ASBottomSheet/ASBottomSheet.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LocalizationSystem/LocalizationSystem.framework"
